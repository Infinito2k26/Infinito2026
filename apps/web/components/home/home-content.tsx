...
// apps/web/app/page.tsx and apps/web/app/dashboard/page.tsx.
export default function HomeContent({ festDates }: { festDates: FestDates }) {
  return (
    <>
      <Hero />
      ...
      <section className={styles.schedule}>
        <Reveal className={styles.sectionHead}>
          <p className="eyebrow">{festDates.label}</p>
